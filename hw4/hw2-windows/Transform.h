...
public:
	...
	static void cam_y(vec3 &eye, vec3 &center, float amount);
	static void cam_z(vec3 &eye, vec3 &center, float amount);
	static void cam_x(vec3 &eye, vec3 &center, vec3 &up, float amount);
	static void cam_rotate(vec3 &eye, vec3 &center, float angle);
};
